...
function carregarLogoBase64(url) {
  return new Promise((resolve) => {
    ...
    img.onerror = function () {
      resolve(null); // Caso não encontre a logo.png, prossegue sem travar
    };
    img.src = url;
  });
}
...
async function gerarPDF(evento, local, responsavel, dataHora, itens, observacoes, fotos) {
  ...
  // Adicionar Logo se existir na pasta (logo.png)
  ...
  // Rodapé do Desenvolvedor em todas as páginas do PDF
